...
<!-- div class="alert alert-warning">
    ...
    <span  style="float:right;">
        <a type="submit" class="btn btn-default btn-primary tab-nav" data-tab="prev"><span class="glyphicon glyphicon-chevron-left"></span> Веб</a>
        <a type="submit" class="btn btn-default btn-primary tab-nav" data-tab="next">Поддержка <span class="glyphicon glyphicon-chevron-right"></span></a>
    </span>
    </div>
