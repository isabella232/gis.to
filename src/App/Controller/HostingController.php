...
class HostingController
{
    ...
    public function show($id)
    {
        ...
        $html .= '<table class="table">
                <tr><td>' . s('Адрес') . '</td><td>' . ($data['status_id'] ? '<a href="http://' . escape($item['instance_id']) . '.gis.to/" target="_blank">http://' . escape($item['instance_id'] . '.gis.to/</a>') : s(escape($item['instance_id']) . '.gis.to')) . '</td></tr>
